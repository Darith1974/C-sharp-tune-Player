...
namespace ConsoleApplication1
{
    class Program
    {
        ...
        static void AssembleMusic(string music)
        {
            ...
            PlayMusic(ref output, ref duration);
            // this method will take the note assembled and play the music.



        }
        static void PlayMusic(ref int[] output, ref  int[] duration)
        {
