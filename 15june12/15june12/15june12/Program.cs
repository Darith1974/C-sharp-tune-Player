...
namespace ConsoleApplication1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Music MusicTest = new Music(music);
            // Here i create a object MusicTest of type Music which takes in the string music as a argrument. 
            MusicTest.AssembleMusic();
            // Here i access the method available to the class to act on the object MusicTest. The method will convert the song into a sequence of freqencies with specific
            // duration
            MusicTest.PlayMusic();
            //This method will take the two public arrays of the class, output and duration output each frequency using console.beep.
        }
    }
    class Music
    {
        ...
        public int[] duration = new int[1000];
        // I made these two arrays public so they could be accessed by the method sound() below.
        public Music()
        {
            song = "";
            
        }
        // This will initialis the object if no initial argument is given.

        public Music(string name)
        {
            this.song = name;
        }
        // This method will initialise the object when a initial string is passed in the initial declaration.
        ...
        //This method actually plays the music using the output & duration arrays through the console.beep function.

        public void AssembleMusic()
        {
            ...
            char[] musicArray = song.ToCharArray();
            ...
            // note, notes[j].
            {
                ...
                else if ((musicArray[i] == notes[j]) && (char.IsDigit(song[i + 1])))
                {
